...
const Toprated = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          'https://api.themoviedb.org/3/movie/top_rated?api_key=fabf45cc64f54095c2866ebcd1a8dfa3'
        );
  ...
  return (
    <div className="bg-gray-700 p-10 text-white min-h-screen">
      <h2 className="text-white text-center font-semibold text-3xl mb-4">Top Rated Movies</h2>
